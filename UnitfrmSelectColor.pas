...
type
  ...
  public
    function ShowModalC(OldColor: TColor): TColor;
  protected
...
function TfrmSelectColor.ShowModalC(OldColor: TColor): TColor;
begin
  OldSwatch.Color := OldColor;
  NewSwatch.Color := OldColor;
  if (OldColor = clDefault) then begin
    chkDefault1.Checked := True;
    chkDefault1.OnMouseUp(chkDefault1, mbLeft, [], 0, 0);
  end
  else if (OldColor = clNone) then begin
    chkNone1.Checked := True;
    chkNone1.OnMouseUp(chkNone1, mbLeft, [], 0, 0);
  end;
